...
<div class="biblio">
    	<div class="row">
      <div class="biblioBox col-sm-6 col-md-4"> <img src="http://libraries-dev.mit.edu/news/files/2014/11/biblioHeader.png" alt="Bibliotech Header" width="331" height="75" /> </div>
