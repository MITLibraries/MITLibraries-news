...
<!-- ////////////////////////END END ONLY VISIBLE ON MOBILE\\\\\\\\\\\\\\\\\\\\ -->
 ...
 <div class="hidden-xs hidden-sm col-md-12 clearfix">
    <div class="col-xs-3 col-xs-B-6 col-sm-8 col-lg-8 col-md-8" onClick='location.href="<?php echo get_post_permalink(); ?>"' style="padding-right:0px;" > <img src="<?php the_field("featuredListImg") ?>" class="img-responsive" width="679" height="256" alt="<?php the_title(); ?>" /> </div>
    <div class="hidden-xs bgWhite col-xs-12 col-xs-B-6 col-sm-4 col-md-4 col-lg-4" onClick='location.href="<?php echo get_post_permalink(); ?>"'>
      <h2>
        <?php the_title();?>
      </h2>
...
?>
    ...
    <div id="theBox" class="col-xs-12 col-xs-B-6 col-sm-4 col-md-4 col-lg-4">
