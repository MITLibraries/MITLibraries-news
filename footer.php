...
?>
	...
	<footer id="mitFooter" class="footer-main flex-container">
		...
		<div class="identity flex-container">
			...
			<div class="social flex-container">
				...
				<a href="http://libguides.mit.edu/googlescholar" title="Google Scholar">
					<svg class="icon-social--google-scholar" xmlns="http://www.w3.org/2000/svg" width="189.6" height="192" viewBox="0 0 800 282.4"><path d="M758.2 491.1L600.8 527.4C537 537.3 479.8 546.2 419.2 546.2 115.5 546.2 0 322.8 0 147.8 0-65.7 164-263.8 444.6-263.8 504-263.8 561.2-255 612.9-240.7 695.5-217.5 734-188.9 758.2-172.4L666.8-85.5 628.3-76.7 655.9-120.7C618.5-157 550.2-224.1 420.4-224.1 246.5-224.1 115.5-92.1 115.5 100.5 115.5 307.4 265.2 502.1 505.1 502.1 575.5 502.1 611.8 487.8 644.8 474.6L644.8 297.4 478.7 306.2 566.7 258.9 800 258.9 771.4 286.4C763.7 293 762.6 295.3 760.4 304 759.3 314 758.2 345.9 758.2 356.9L758.2 491.1 758.2 491.1z"/></svg>
				</a>
